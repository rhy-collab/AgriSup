...
private class PopUpWindowView: UIView {
    ...
    init() {
        ...
        popupTitle.backgroundColor = #colorLiteral(red: 0.3382441103, green: 0.7381854653, blue: 0, alpha: 1)
        popupTitle.layer.masksToBounds = true
        popupTitle.adjustsFontSizeToFitWidth = true
        popupTitle.clipsToBounds = true
        popupTitle.font = UIFont(name: "Poppins", size: 23.0)
        popupTitle.numberOfLines = 1
        popupTitle.textAlignment = .center
        
        // Popup Text
        popupText.textColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
        ...
        popupButton.backgroundColor = #colorLiteral(red: 0.3382441103, green: 0.7381854653, blue: 0, alpha: 1)
